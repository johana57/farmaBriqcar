...
//                'domain_controllers' => explode(' ', env('ADLDAP_CONTROLLERS', 'corp-dc1.corp.acme.org corp-dc2.corp.acme.org')),
                'domain_controllers' => explode(' ', env('ADLDAP_CONTROLLERS', '10.50.0.48')),
                ...
                |--------------------------------------------------------------------------
                |
                | The port option is used for authenticating anAuth with LDAP d binding to your LDAP server.
                |
                */
...
//                'base_dn' => env('ADLDAP_BASEDN', 'dc=corp,dc=acme,dc=org'),
                  'base_dn' => env('ADLDAP_BASEDN', 'ou=vpc-users, ou=venprecar, dc=orinoco-iron, dc=com'),
                ...
                */
                ...
                'admin_username' => env('ADLDAP_ADMIN_USERNAME', 'servicesvpc@orinoco-iron.com'),
                'admin_password' => env('ADLDAP_ADMIN_PASSWORD', 'xanaeche5Aepaej'),
